...
async function testLatestPayment() {
  console.log('🧪 Testing Latest Updated PAID Payment Detection...\n');
  
  const externalId = 'TRX-6CFA5EC007-1756482335856';
  ...
  try {
    ...
    console.log('2️⃣ Testing getQRISStatus with latest updated payment...');
    try {
